    ...
    <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
        ...
        <div class="text-center">
            <a href="#"
                ...
                <img src="{{ Vite::asset('resources/img/logo_cq.png') }}" class="mr-2 h-32" viewBox="0 0 33 33">
