                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            <img class="mr-4 w-16 h-16 rounded-full" src="" alt="Clara Quintela">
                            <div>
                                <a href="#" rel="author"
                                    class="text-xl font-bold text-gray-900 dark:text-white">Clara Quintela</a>
                                <p class="text-base text-gray-500 dark:text-gray-400">Developer/Journalist/TextileArtist</p>
                                <p class="text-base text-gray-500 dark:text-gray-400"><time pubdate datetime="2024-04-12"
                                        title="April 12th, 2024">Apr. 12, 2024</time></p>
                            </div>
                        </div>
                    </address>
                    <h1
